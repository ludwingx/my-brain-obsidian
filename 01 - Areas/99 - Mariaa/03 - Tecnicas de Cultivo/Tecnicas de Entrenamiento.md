...
### Poda Apical
Consiste en cortar la punta principal para romper la dominancia apical.
- **Resultado:** La planta desarrolla dos colas principales.
- **Momento:** A partir del 3er o 4to nudo.

### Poda FIM (Fuck I Missed)
Similar a la apical pero dejando un 10-20% del brote.
- **Resultado:** Pueden nacer de 4 a 8 nuevas colas.

<!-- ![Placeholder: Diagrama de Poda Apical vs FIM]() -->
